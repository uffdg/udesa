...
- **CFO**: quiere riesgo y retorno pronto, no al final — pero el propio
  ...
  **temprano** (minuto 4:45, no al cierre) pero **en el mismo orden interno
  ...
  escenarios → riesgo principal → plan de des-arriesgamiento. Recién después
  del ROI aparecen las dos slides de economía del proyecto y CAC/LTV.
...
**Slides posteriores al ROI — Economía y CAC/LTV (apoyo visual, 0:40 si se usan)**
